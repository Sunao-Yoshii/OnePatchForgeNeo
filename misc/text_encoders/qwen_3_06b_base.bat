...
set "DOWNLOAD_DIR=%PROJECT_ROOT%\models\text_encoder"
set "DOWNLOAD_FILE=qwen_3_06b_base.safetensors"
set "REPO_ID=circlestone-labs/Anima"
set "REPO_DIR=split_files/text_encoders/"
