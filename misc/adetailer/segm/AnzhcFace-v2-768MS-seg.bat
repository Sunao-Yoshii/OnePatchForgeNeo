...
set "DOWNLOAD_DIR=%PROJECT_ROOT%\models\adetailer\segm"
set "DOWNLOAD_FILE=AnzhcFace-v2-768MS-seg.pt"
set "REPO_ID=Anzhc/Anzhcs_YOLOs"
set "REPO_DIR=Anzhc%%%%%%%%20Face%%%%%%%%20seg%%%%%%%%20768MS%%%%%%%%20v2%%%%%%%%20y8n.pt"
